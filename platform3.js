...
<img src="https://kufarm.io/static/kufarm/about3.jfif" alt="" class="round">
        <h3 style="padding-right: 22px;" class="m-0 text-lg">John Anderson <img style="display: revert;max-width: 10%;vertical-align: top;padding-top: 5px;" src="https://cdnjs.cloudflare.com/ajax/libs/twemoji/12.1.1/72x72/1f44b.png" alt="👋" class="emoji"></h3>
          <br></br>
      ...
      <div id="chat-input-container" class=" p-4 border-t border-gray-200">
        <div class="flex space-x-4 items-center">
          <input type="text" id="chat-input" class="flex-1 border border-gray-300 rounded-full px-4 py-2 outline-none w-3/4" placeholder="Type your message...">
          <button id="chat-submit" class="bg-gray-800 text-white rounded-full px-4 py-2 cursor-pointer">
...
Please provide your email address so we can get in touch with you.
 ...
 <div class="flex space-x-4 items-center">
            <button id="chat-email-submit" class="bg-gray-800 text-white rounded-full px-4 py-2 cursor-pointer">Send
            </button>
        </div>
      </div>
    </div>
